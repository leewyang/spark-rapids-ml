...
class _PCACumlParams(_CumlParams, _PCAParams, HasInputCols, HasOutputCols):
    ...
    def setInputCol(self: P, value: Union[str, Sequence[str]]) -> P:
        """
    ...
    def setInputCols(self: P, value: Sequence[str]) -> P:
        """
    ...
    def setOutputCol(self: P, value: Union[str, Sequence[str]]) -> P:
        """
    ...
    def setOutputCols(self: P, value: Sequence[str]) -> P:
        """
