...
class _KMeansCumlParams(_CumlParams, _KMeansParams, HasFeaturesCols):
    ...
    def getFeaturesCol(self) -> Union[str, Sequence[str]]:  # type: ignore
        """
    ...
    def setFeaturesCol(self: P, value: Union[str, Sequence[str]]) -> P:
        """
    ...
    def setFeaturesCols(self: P, value: Sequence[str]) -> P:
        """
